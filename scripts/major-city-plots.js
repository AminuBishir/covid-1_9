...
fetch("https://raw.githubusercontent.com/AminuBishir/covid-1_9/master/data/ng_states.json")
    ...
    .then(function(data)
    {
        ...
        if(total_confirmed >0){
			...
			document.getElementById('breaking').innerHTML += '<font style="color:red;font-weight:bold;margin-left:5px;font-size:20px">Covid19 Alert: </font><font style="margin-left:5px;font-size:18px"> 23 new cases have been confirmed by NCDC as at 8:00pm  1/04/2020, 9 in Lagos, 7 in FCT, 5 in Akwai Ibom, 1 in Kaduna and 1 in Bauchi, bringing the total confirmed cases to <font style="color:red;font-weight:bold;margin-left:5px;font-size:20px">'+total_confirmed+'</font></font>'
